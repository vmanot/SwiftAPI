...
public protocol HierarchicalNamespaceSegmentRepresentable: HierarchicalNamespaceRepresentable {
    init?(namespaceSegment: HierarchicalNamespace.Segment)
...
extension HierarchicalNamespaceSegmentRepresentable {
...
extension AnyStringIdentifier: HierarchicalNamespaceSegmentRepresentable {
    public init?(namespaceSegment: HierarchicalNamespace.Segment) {
